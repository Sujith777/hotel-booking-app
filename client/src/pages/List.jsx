...
const List = () => {
  ...
  return (
    <div className="w-full">
      <Navbar />
      <Header type="list" />
      <div className="w-full p-4 gap-4 flex flex-col md:flex-row justify-center">
        <div className="flex text-lg flex-col gap-2 md:basis-1/4 bg-yellow-400 p-2 rounded-md h-fit md:sticky top-2">
